...
interface SystemPlayerDialogueEditorProps {
  node: Node;
  onChange: (newNode: Node) => void;
}

const SystemPlayerDialogueEditor: React.FC<SystemPlayerDialogueEditorProps> = ({ node, onChange }) => {
...
export default SystemPlayerDialogueEditor;